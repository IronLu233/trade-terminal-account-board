module.exports = {
  ...
  deploy: {
    app: {
      ...
      "post-deploy":
        "bun install && bun run build && pm2 startOrRestart ecosystem.config.js --only account-board-v2",
    },
    worker: {
      user: "ubuntu",
      ...
      "post-deploy":
        "bun install && pm2 startOrRestart ecosystem.config.js --only account-board-worker-v2",
    },
  },
};
